...
export class Backend implements backendInterface {
    ...
    async addCoachingTopic(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCoachingTopic(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addGoals(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addGoals(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addSessionToHistory(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSessionToHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCoachingTopics(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoachingTopics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGoals(arg0: Principal, arg1: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGoals(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSessionHistory(arg0: Principal): Promise<{
        __kind__: "Empty";
        Empty: boolean;
    } | {
        __kind__: "Sessions";
    ...
    async removeGoal(arg0: string, arg1: string): Promise<{
        __kind__: "Success";
        Success: string;
    } | {
        __kind__: "Failure";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.removeGoal(arg0, arg1);
    ...
    async setGoals(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setGoals(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startSession(arg0: string): Promise<{
        __kind__: "Error";
        Error: string;
    } | {
        __kind__: "Success";
    ...
    async validateGoal(arg0: Principal, arg1: string, arg2: string): Promise<{
        __kind__: "GoalNotFound";
        GoalNotFound: string;
    } | {
        __kind__: "GoalExists";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.validateGoal(arg0, arg1, arg2);
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "GoalNotFound" in value ? {
        __kind__: "GoalNotFound",
        GoalNotFound: value.GoalNotFound
    } : "GoalExists" in value ? {
        __kind__: "GoalExists",
        GoalExists: value.GoalExists
    } : value;
}
